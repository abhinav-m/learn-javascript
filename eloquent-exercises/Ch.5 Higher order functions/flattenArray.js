...
function flatten_es5_2(array) {
  return array.reduce(function(a, b) {
    return a.concat(Array.isArray(b) ? flatten_es5_2(b) : b)
  }, [])
}
...
console.log(flatten_es5_2(multiDepth));

console.log(flatten_es5_2([1, {},
  [3, [
    [4]
  ]]
]))
