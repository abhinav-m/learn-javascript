...
const pattern = /'(\w+)'/;
let tests = ["'test'", "'hello' world", "aren't shouldn't 'couldnt'"];

tests.forEach(v => console.log(v.replace(pattern, '"$1"')));
//Eloquent solution -> console.log(text.replace(/(^|\W)'|'(\W|$)/g, '$1"$2'));
